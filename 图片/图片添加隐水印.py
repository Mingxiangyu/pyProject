# -*- codeing = utf-8 -*-
# @Time :2023/3/21 11:42
# @Author :xming
# @Version :1.0
# @Descriptioon :
# @Link : https://mp.weixin.qq.com/s/_YAhKmOLncF7hAatmBqAuQ
# @File :  图片添加隐水印.py
...
if __name__ == "__main__":
    # 将小图藏于大图中，并保存结果
    # source_path = "1.png"
    source_path = "E:\WorkSpace\pyWorkSpace\pyProject\图片\1.png"
    # 水印图片
    watermark_path = "2.png"
    # 结果图片
    res_img_path = "res.png"
    # big_with_small(source_path, txt_img_path, res_img_path)
    ...
    big_with_small(source_path, txt_img_fname, txt_res_img_path)
